      %$$ reset RELEASE deixar para o job de compilacao                       0000020001.001.000
                                                                              0000040001.001.000
      $$ sharing = sharedbyall                                                00001000          
      begin                                                                   00002000          
                                                                              0000300001.001.000
         library LibRvCh(title="*PC/LIB/EXTERNCOMM/RV.");                     0000430001.001.000
                                                                              0000450001.001.000
         procedure EnableQ(TimeLimitV);                                       00005000          
            ebcdic array TimeLimitV[0];                                       00006000          
         library LibRvCh(actualname="ENABLE");                                00007000          
                                                                              00008000          
         procedure DisableQ();                                                00009000          
         library LibRvCh(actualname="DISABLE");                               00010000          
                                                                              00011000          
         procedure SendQ(msg, tam, status);                                   00012000          
            ebcdic array msg, tam, status[0];                                 00013000          
         library LibRvCh(actualname="SEND");                                  00014000          
                                                                              00015000          
         procedure ReceiveQ(msg, status);                                     00016000          
            ebcdic array msg, status[0];                                      00017000          
         library LibRvCh(actualname="RECEIVE");                               00018000          
                                                                              00019000          
                                                                              00020000          
